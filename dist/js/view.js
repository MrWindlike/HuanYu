...
(function ($) {
    var TEMPLATE = ['  <div class="left">', '                    <span class="date">{{day}}</span><br>', '                    <span class="month">{{month}}</span><br>', '                    <span class="year">{{year}}</span>', '                </div>', '                ', '                <div class="middle">', '                    <div class="title">', '                        <a href="javascript:;">{{title}}</a>', '                    </div>', '                    <div class="detail">', '                        <span>发布者:{{publisher}}</span>', '                        <span>发布时间：{{time}}</span>', '                    </div>', '                    <div class="content">', '                       {{content}}', '                    </div>', '                </div>'].join("");
    var other = ['<div class="more">', '        <span>上一篇</span><a href={{prevsrc}}>{{prev}}</a><br>', '        <span>下一篇</span><a href={{nextsrc}}>{{next}}</a>', '        </div>'].join("");
